...
//	}
	...
	@GetMapping("/getEmployeeAgeGreater")
	public List<Employee> getEmployeeAgeGreater(@RequestParam int age){
		return employeeFunction.getEmployeeAgeGreater(age);
	}
	@GetMapping("/getEmployeeAgeandRegion")
	public List<Employee> getEmployeeAgeandRegion(@RequestParam String region,@RequestParam int age){
		return employeeFunction.getEmployeeAgeandRegion(region,age);
	}
	@GetMapping("/getEmployeeNameStartwith")
	public List<Employee> getEmployeeNameStartwith(@RequestParam String name){
		return employeeFunction.getEmployeeNameStartwith(name);
	}
	
	@GetMapping("/getEmployeeMaxSalary")
	public List<Employee> getEmployeeMaxSalary(){
		return employeeFunction.getEmployeeMaxSalary();
	}
